...
check_dependencies() {
    ...
    if ! command -v socat > /dev/null; then
        echo -e "${RED}ERROR:${NC} socat not installed"
        ...
        echo -e "  ┌────────────────────┐"
        echo -e "  │ \$ ${CYAN}pacman${NC} ${GREEN}-Sy${NC} socat │"
        echo -e "  └────────────────────┘"
        echo -e ""
    fi
    
    if ! command -v sqlite3 > /dev/null; then
        echo -e "${YELLOW}WARNING:${NC} sqlite3 not installed"
        ...
        echo -e "  ┌──────────────────────┐"
        echo -e "  │ \$ ${CYAN}pacman${NC} ${GREEN}-Sy${NC} sqlite3 │"
        echo -e "  └──────────────────────┘"
    fi
